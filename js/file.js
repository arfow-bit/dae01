...
const file = (()=>{
    ...
    const handler_download_json_file = (e)=>{
        ...
        document.querySelector("#download_json_file").download = "test.json";
        document.querySelector("#download_json_file").href = window.URL.createObjectURL( blob );
    ...
    const init =()=>{
        ...
        document.querySelector("#download_json_file").addEventListener("click",handler_download_json_file);
